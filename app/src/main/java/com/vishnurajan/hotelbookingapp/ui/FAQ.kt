...
import com.vishnurajan.hotelbookingapp.R
...
fun FAQ() {
    Column(
        ...
        Image(painter = painterResource(id = R.drawable.faq), contentDescription = "FAQ", modifier = Modifier.width(300.dp).height(130.dp))
        Text(
